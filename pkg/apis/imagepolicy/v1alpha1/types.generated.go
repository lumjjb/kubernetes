...
func (x *ImageReviewStatus) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			const yyr2 bool = false
			yyq2[1] = x.Reason != ""
			yyq2[2] = len(x.ContainerRewrites) != 0
			var yynn2 int
			if yyr2 || yy2arr2 {
				r.EncodeArrayStart(3)
			} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					if x.ContainerRewrites == nil {
						...
						if false {
							...
							h.encSliceImageReviewContainerSpec(([]ImageReviewContainerSpec)(x.ContainerRewrites), e)
						}
					}
				} else {
					r.EncodeNil()
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey1234)
					r.EncodeString(codecSelferC_UTF81234, string("containerRewrites"))
					z.EncSendContainerState(codecSelfer_containerMapValue1234)
					if x.ContainerRewrites == nil {
						r.EncodeNil()
					} else {
...
func (x *ImageReviewStatus) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		case "containerRewrites":
			if r.TryDecodeAsNil() {
				x.ContainerRewrites = nil
			} else {
				yyv8 := &x.ContainerRewrites
				yym9 := z.DecBinary()
				_ = yym9
				if false {
				} else {
					h.decSliceImageReviewContainerSpec((*[]ImageReviewContainerSpec)(yyv8), d)
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *ImageReviewStatus) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		yyv15 := &x.ContainerRewrites
		yym16 := z.DecBinary()
		_ = yym16
		if false {
		} else {
			h.decSliceImageReviewContainerSpec((*[]ImageReviewContainerSpec)(yyv15), d)
		}
	}
	for {
		yyj10++
